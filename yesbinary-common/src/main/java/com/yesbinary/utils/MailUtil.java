...
public class MailUtil {
    ...
    public static void sendMail(String to, String code) {
        ...
        try {
            ...
            // 3.3设置邮件的主题
            message.setSubject("来自Swish的激活邮件");
            // 3.4设置邮件的正文
            message.setContent("<h1>来自平台的激活邮件，激活请点击以下链接：</h1><h3><a href='http://192.168.1.100:8080/active/" + code + "'>http://localhost:8080/active/" + code + "</a></h3>", "text/html;charset=UTF-8");
            // 4.发送邮件
//            System.out.println("account:"+account+"; passwod:"+password+"; to:"+to);
    ...
    public static void findPasswordMail(String to, String code) {
        ...
        try {
            ...
            message.setRecipient(RecipientType.TO, new InternetAddress(to));
            // 3.3设置邮件的主题
            message.setSubject("来自Swish的验证邮件");
            // 3.4设置邮件的正文
