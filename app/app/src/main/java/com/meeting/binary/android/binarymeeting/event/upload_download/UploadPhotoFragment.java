...
import static com.meeting.binary.android.binarymeeting.service.generetor.BaseUrlGenerator.BINARY_BASE_URL;
...
public class UploadPhotoFragment extends Fragment {
    ...
    public static UploadPhotoFragment newInstance(String id) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.upload_photo_fragment, container, false);

        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Uplaod Photo");
