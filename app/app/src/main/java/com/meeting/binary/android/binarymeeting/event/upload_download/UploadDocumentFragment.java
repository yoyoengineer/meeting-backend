...
public class UploadDocumentFragment extends Fragment {
    ...
    public static UploadDocumentFragment newInstance(String id) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.upload_document_layout, container, false);

        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Uplaod Document");
