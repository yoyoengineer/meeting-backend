...
public class ViewFileUploadedFragment extends Fragment {
    ...
    public static ViewFileUploadedFragment newInstance(String eventId) {
        Bundle args = new Bundle();
        args.putString(EXTRA_MESSAGE_FILE, eventId);
        ViewFileUploadedFragment fragment = new ViewFileUploadedFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.view_file_upload_fragment, container, false);
        mDocumentRecycler = view.findViewById(R.id.recycler_id_view_upload);
    ...
    private void addTofile(List<FileModel> fileModels){
        for (int i = fileModels.size()-1; i >=0; i--){
    ...
    private class FileHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public FileHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.view_file_list_item, parent, false));
