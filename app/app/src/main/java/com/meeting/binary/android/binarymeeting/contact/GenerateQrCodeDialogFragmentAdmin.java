...
public class GenerateQrCodeDialogFragmentAdmin extends DialogFragment {
    ...
    public static GenerateQrCodeDialogFragmentAdmin newInstance(String id) {
        Bundle args = new Bundle();
        args.putString(EXTRA_ID, id);
        GenerateQrCodeDialogFragmentAdmin fragment = new GenerateQrCodeDialogFragmentAdmin();
    ...
    private void requestQrCode(){
        ...
        GlideUrl glideUrl = new GlideUrl(BaseUrlGenerator.BINARY_BASE_URL + "/event/qrcode/" + eventId , builder.build());
        Glide.with(GenerateQrCodeDialogFragmentAdmin.this)
                .load(glideUrl)
